    ...
    return (
        ...
        <div className="accordion-item" style={myStyle}>
            ...
            <div className="accordion-body" style={myStyle}>
                Textutils gives you a way to anaylzw your text quickly and efficiently. Be it word count, character count
            </div>
            </div>
        </div>
        <div className="accordion-item" style={myStyle}>
            ...
            <div className="accordion-body" style={myStyle}>
                ...
                text. TextUtils reports the number of word and characters. Thus it is suitable for writting text with word/character limit. 
            </div>
            </div>
        </div>
        <div className="accordion-item" style={myStyle}>
